...
def get_files_from_sftp():
    ...
    try:
        with pysftp.Connection(host=sftpHost, port=sftpPort, username=sftpUname, password=sftpPassword,
...
#
#             print(
#                 f'File {record['coupon_name']} has {record_count} records while its converted CSV has {df.shape[0]} records.')
#
